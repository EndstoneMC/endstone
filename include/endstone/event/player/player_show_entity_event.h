 ...
 */
class PlayerShowEntityEvent final : public PlayerEvent {
public:
    ENDSTONE_EVENT(PlayerShowEntityEvent);

    PlayerShowEntityEvent(const NotNull<Player> &player, Actor &entity)
