...
public:
    using ValuesCallback = AdvancedPieCallback;

    AdvancedPie(std::string chart_id, ValuesCallback get_values)
...
private:
    ...
    void dispatch(detail::ChartVisitor &visitor) override { visitor.visitAdvancedPie(getChartId(), get_values_); }
