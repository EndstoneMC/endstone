...
public:
    ...
    static constexpr auto ExperienceOrb = ActorTypeId::minecraft("xp_orb");
    static constexpr auto ExperienceBottle = ActorTypeId::minecraft("xp_bottle");
    static constexpr auto EyeOfEnder = ActorTypeId::minecraft("eye_of_ender_signal");
    ...
    static constexpr auto ItemEntity = ActorTypeId::minecraft("item");
    ...
    static constexpr auto MinecartChest = ActorTypeId::minecraft("chest_minecart");
    static constexpr auto MinecartCommandBlock = ActorTypeId::minecraft("command_block_minecart");
    static constexpr auto MinecartHopper = ActorTypeId::minecraft("hopper_minecart");
    static constexpr auto MinecartTnt = ActorTypeId::minecraft("tnt_minecart");
    ...
    static constexpr auto PrimedTnt = ActorTypeId::minecraft("tnt");
