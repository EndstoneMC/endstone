...
[**ClassList**](annotated.md) **>** [**std**](namespacestd.md) **>** [**formatter&lt; endstone::DamageSource &gt;**](structstd_1_1formatter_3_01endstone_1_1DamageSource_01_4.md)
...
```C++
using std::formatter< endstone::DamageSource >::Type =  endstone::DamageSource;
```
...
inline auto std::formatter< endstone::DamageSource >::format (
    const Type & val,
    FormatContext & ctx
) const
```
