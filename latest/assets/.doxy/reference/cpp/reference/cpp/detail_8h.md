...
| define  | [**ENDSTONE\_VERSION\_PATCH**](detail_8h.md#define-endstone_version_patch)  `2`<br> |
...
| define  | [**MINECRAFT\_VERSION\_PATCH**](detail_8h.md#define-minecraft_version_patch)  `3`<br> |
...
```C++
#define MINECRAFT_VERSION_PATCH `3`
```
