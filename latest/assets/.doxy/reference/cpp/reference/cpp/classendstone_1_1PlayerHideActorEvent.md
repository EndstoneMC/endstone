...
# Class endstone::PlayerHideActorEvent



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**PlayerHideActorEvent**](classendstone_1_1PlayerHideActorEvent.md)



_Called when a visible actor is hidden from a player._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
|   | [**ENDSTONE\_EVENT**](#function-endstone_event) ([**PlayerHideActorEvent**](classendstone_1_1PlayerHideActorEvent.md)) <br> |
|   | [**PlayerHideActorEvent**](#function-playerhideactorevent) ([**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Player**](classendstone_1_1Player.md) &gt; & player, [**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Actor**](classendstone_1_1Actor.md) &gt; & actor) <br> |
|  [**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Actor**](classendstone_1_1Actor.md) &gt; & | [**getActor**](#function-getactor) () const<br>_Gets the actor hidden from the player._  |
...
**See also:** [**Player::hideActor()**](classendstone_1_1Player.md#function-hideactor) 
...
```C++
endstone::PlayerHideActorEvent::ENDSTONE_EVENT (
...
### function PlayerHideActorEvent 

```C++
inline endstone::PlayerHideActorEvent::PlayerHideActorEvent (
...
_Gets the actor hidden from the player._ 
```C++
inline const  NotNull < Actor > & endstone::PlayerHideActorEvent::getActor () const
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/event/player/player_hide_actor_event.h`
