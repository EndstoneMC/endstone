...
| Type | Name |
| ---: | :--- |
| typedef std::function&lt; std::optional&lt; DrilldownValues &gt;()&gt; | [**Callback**](#typedef-callback)  <br> |
...
```C++
using endstone::DrilldownPie::Callback =  std::function<std::optional<DrilldownValues>()>;
```
