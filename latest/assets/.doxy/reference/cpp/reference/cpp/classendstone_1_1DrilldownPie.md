...
[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**DrilldownPie**](classendstone_1_1DrilldownPie.md)



_A bStats pie chart with grouped named values._ 
...
| Type | Name |
| ---: | :--- |
| typedef std::function&lt; std::optional&lt; std::unordered\_map&lt; std::string, std::unordered\_map&lt; std::string, [**int**](classendstone_1_1Identifier.md) &gt; &gt; &gt;()&gt; | [**Callback**](#typedef-callback)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**DrilldownPie**](#function-drilldownpie) (std::string chart\_id, Callback get\_values) <br> |
...
```C++
inline endstone::DrilldownPie::DrilldownPie (
    std::string chart_id,
    Callback get_values
) 
```
...
```C++
inline virtual std::optional< JsonObject > endstone::DrilldownPie::getChartData () override
```
