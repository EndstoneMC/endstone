...
# Class endstone::SmithingTrimRecipe



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**SmithingTrimRecipe**](classendstone_1_1SmithingTrimRecipe.md)



_Represents a smithing trim recipe._ 
...
|   | [**~SmithingTrimRecipe**](#function-smithingtrimrecipe) () override<br> |
...
```C++
virtual Nullable < RecipeIngredient > endstone::SmithingTrimRecipe::getTemplate () const = 0
```
...
### function ~SmithingTrimRecipe 

```C++
endstone::SmithingTrimRecipe::~SmithingTrimRecipe () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/inventory/smithing_trim_recipe.h`
