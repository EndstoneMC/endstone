...
# Class endstone::AbilityId

**template &lt;[**typename**](classendstone_1_1Identifier.md) [**T**](classendstone_1_1Identifier.md)&gt;**



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**AbilityId**](classendstone_1_1AbilityId.md)



_Represents the identifier of a player ability, carrying the type of the ability's value._ 
...
| Type | Name |
| ---: | :--- |
|  [**constexpr**](classendstone_1_1Identifier.md) [**AbilityId**](classendstone_1_1AbilityId.md) | [**minecraft**](#function-minecraft) ([**const**](classendstone_1_1Identifier.md) std::string\_view key) noexcept<br> |
...
```C++
inline constexpr endstone::AbilityId::Identifier (
    const  char * s
) noexcept
```
...
```C++
static inline constexpr  AbilityId endstone::AbilityId::minecraft (
    const std::string_view key
) noexcept
```
