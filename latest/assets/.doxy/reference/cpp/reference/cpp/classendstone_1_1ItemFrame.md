...
[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**ItemFrame**](classendstone_1_1ItemFrame.md)



_Represents a captured state of an item frame._ 
...
| Type | Name |
| ---: | :--- |
| virtual std::optional&lt; [**ItemStack**](classendstone_1_1ItemStack.md) &gt; | [**getItem**](#function-getitem) () const = 0<br>_Gets the item in this frame._  |
| virtual [**float**](classendstone_1_1Identifier.md) | [**getItemDropChance**](#function-getitemdropchance) () const = 0<br>_Gets the chance of the item being dropped upon this frame's destruction._  |
| virtual [**Rotation**](namespaceendstone.md#enum-rotation) | [**getRotation**](#function-getrotation) () const = 0<br>_Gets the rotation of the frame's item._  |
| virtual [**void**](classendstone_1_1Identifier.md) | [**setItem**](#function-setitem) ([**const**](classendstone_1_1Identifier.md) std::optional&lt; [**ItemStack**](classendstone_1_1ItemStack.md) &gt; & item) = 0<br>_Sets the item in this frame._  |
| virtual [**void**](classendstone_1_1Identifier.md) | [**setItemDropChance**](#function-setitemdropchance) ([**float**](classendstone_1_1Identifier.md) chance) = 0<br>_Sets the chance of the item being dropped upon this frame's destruction._  |
...
_Gets the item in this frame._ 
```C++
virtual std::optional< ItemStack > endstone::ItemFrame::getItem () const = 0
```
...
_Gets the chance of the item being dropped upon this frame's destruction._ 
```C++
virtual float endstone::ItemFrame::getItemDropChance () const = 0
```
...
_Gets the rotation of the frame's item._ 
```C++
virtual Rotation endstone::ItemFrame::getRotation () const = 0
```
...
_Sets the item in this frame._ 
```C++
virtual void endstone::ItemFrame::setItem (
...
* `item` the new item, or `std::nullopt` to empty the frame 
...
_Sets the chance of the item being dropped upon this frame's destruction._ 
```C++
virtual void endstone::ItemFrame::setItemDropChance (
    float chance
) = 0
```
...
* `chance` the chance of the item being dropped 
...
_Sets the rotation of the frame's item._ 
```C++
virtual void endstone::ItemFrame::setRotation (
    Rotation rotation
) = 0
```
