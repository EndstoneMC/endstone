...
# Class endstone::AdvancedBarChart



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**AdvancedBarChart**](classendstone_1_1AdvancedBarChart.md)



_A bStats bar chart with several bars per category._ 
...
| Type | Name |
| ---: | :--- |
|   | [**AdvancedBarChart**](#function-advancedbarchart) (std::string chart\_id, Callback get\_values) <br> |
...
```C++
inline endstone::AdvancedBarChart::AdvancedBarChart (
    std::string chart_id,
    Callback get_values
) 
```
...
```C++
inline virtual std::optional< JsonObject > endstone::AdvancedBarChart::getChartData () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/metrics/advanced_bar_chart.h`
