...
# Class endstone::MultiLineChart



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**MultiLineChart**](classendstone_1_1MultiLineChart.md)



_A bStats line chart with a line per named value._ 
...
| Type | Name |
| ---: | :--- |
|   | [**MultiLineChart**](#function-multilinechart) (std::string chart\_id, Callback get\_values) <br> |
...
```C++
using endstone::MultiLineChart::Callback =  std::function<std::optional<StringValues>()>;
```
...
```C++
inline endstone::MultiLineChart::MultiLineChart (
    std::string chart_id,
    Callback get_values
) 
```
...
```C++
inline virtual std::optional< JsonObject > endstone::MultiLineChart::getChartData () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/metrics/multi_line_chart.h`
