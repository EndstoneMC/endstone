...
# Class endstone::PlayerBucketEmptyEvent



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**PlayerBucketEmptyEvent**](classendstone_1_1PlayerBucketEmptyEvent.md)



_Called when a player empties a bucket._ 
...
| Type | Name |
| ---: | :--- |
|   | [**ENDSTONE\_EVENT**](#function-endstone_event) ([**PlayerBucketEmptyEvent**](classendstone_1_1PlayerBucketEmptyEvent.md)) <br> |
...
```C++
endstone::PlayerBucketEmptyEvent::ENDSTONE_EVENT (
...
```C++
inline endstone::PlayerBucketEmptyEvent::PlayerBucketEvent (
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/event/player/player_bucket_empty_event.h`
