...
# Class endstone::SimplePie



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**SimplePie**](classendstone_1_1SimplePie.md)



_A bStats pie chart with a single value._ 
...
| Type | Name |
| ---: | :--- |
| typedef std::function&lt; std::optional&lt; std::string &gt;()&gt; | [**Callback**](#typedef-callback)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**SimplePie**](#function-simplepie) (std::string chart\_id, Callback get\_value) <br> |
...
```C++
using endstone::SimplePie::Callback =  std::function<std::optional<std::string>()>;
```
...
```C++
inline endstone::SimplePie::SimplePie (
    std::string chart_id,
    Callback get_value
) 
```
...
```C++
inline virtual std::optional< JsonObject > endstone::SimplePie::getChartData () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/metrics/simple_pie.h`
