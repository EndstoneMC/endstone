...
| Type | Name |
| ---: | :--- |
| virtual bool | [**add**](classendstone_1_1Inventory.md#function-add) (const [**ItemStack**](classendstone_1_1ItemStack.md) & item) = 0<br>_Add the given_ [_**ItemStack**_](classendstone_1_1ItemStack.md) _to the inventory._ |
| virtual std::unordered\_map&lt; int, const [**ItemStack**](classendstone_1_1ItemStack.md) \* &gt; | [**addItem**](classendstone_1_1Inventory.md#function-additem) (std::vector&lt; const [**ItemStack**](classendstone_1_1ItemStack.md) \* &gt; items) = 0<br>_Stores the given ItemStacks in the inventory._  |
| virtual std::unordered\_map&lt; int, std::unique\_ptr&lt; [**ItemStack**](classendstone_1_1ItemStack.md) &gt; &gt; | [**all**](classendstone_1_1Inventory.md#function-all-12) (const [**ItemType**](classendstone_1_1ItemType.md) & type) = 0<br>_Finds all slots in the inventory containing any ItemStacks with the given_ [_**ItemType**_](classendstone_1_1ItemType.md) _._ |
| virtual std::unordered\_map&lt; int, std::unique\_ptr&lt; [**ItemStack**](classendstone_1_1ItemStack.md) &gt; &gt; | [**all**](classendstone_1_1Inventory.md#function-all-22) (const [**ItemStack**](classendstone_1_1ItemStack.md) \* item) = 0<br>_Finds all slots in the inventory containing any ItemStacks with the given_ [_**ItemStack**_](classendstone_1_1ItemStack.md) _._ |
...
| virtual bool | [**contains**](classendstone_1_1Inventory.md#function-contains-13) (const [**ItemType**](classendstone_1_1ItemType.md) & type) const = 0<br>_Checks if the inventory contains any ItemStacks with the given_ [_**ItemType**_](classendstone_1_1ItemType.md) _._ |
...
| virtual bool | [**containsAtLeast**](classendstone_1_1Inventory.md#function-containsatleast-12) (const [**ItemType**](classendstone_1_1ItemType.md) & type, int amount) const = 0<br>_Checks if the inventory contains any ItemStacks with the given_ [_**ItemType**_](classendstone_1_1ItemType.md) _, adding to at least the minimum amount specified._ |
...
| virtual int | [**first**](classendstone_1_1Inventory.md#function-first-12) (const [**ItemType**](classendstone_1_1ItemType.md) & type) const = 0<br>_Finds the first slot in the inventory containing an_ [_**ItemStack**_](classendstone_1_1ItemStack.md) _with the given_[_**ItemType**_](classendstone_1_1ItemType.md) _._ |
...
| virtual void | [**remove**](classendstone_1_1Inventory.md#function-remove-12) (const [**ItemType**](classendstone_1_1ItemType.md) & type) = 0<br>_Removes all stacks in the inventory matching the given_ [_**ItemType**_](classendstone_1_1ItemType.md) _._ |
...
| virtual std::unordered\_map&lt; int, const [**ItemStack**](classendstone_1_1ItemStack.md) \* &gt; | [**removeItem**](classendstone_1_1Inventory.md#function-removeitem) (std::vector&lt; const [**ItemStack**](classendstone_1_1ItemStack.md) \* &gt; items) = 0<br>_Removes the given ItemStacks from the inventory._  |
