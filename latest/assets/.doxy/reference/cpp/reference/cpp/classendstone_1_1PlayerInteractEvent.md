...
| Type | Name |
| ---: | :--- |
| enum  | [**Action**](#enum-action)  <br>_Represents the type of interaction that triggered this event._  |
...
_Represents the type of interaction that triggered this event._ 
```C++
