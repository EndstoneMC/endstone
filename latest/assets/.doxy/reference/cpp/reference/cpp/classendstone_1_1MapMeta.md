...
| virtual bool | [**hasMapId**](#function-hasmapid) () const = 0<br>_Checks for existence of a map ID number._  |
| virtual bool | [**hasMapView**](#function-hasmapview) () const = 0<br>_Checks for existence of an associated map._  |
| virtual void | [**setMapId**](#function-setmapid) (MapId id) = 0<br>_Sets the map ID. This is used to determine what map is displayed._  |
...
| virtual bool | [**hasConflictingEnchant**](classendstone_1_1ItemMeta.md#function-hasconflictingenchant) (const std::string & id) const = 0<br> |
...
| virtual void | [**setLore**](classendstone_1_1ItemMeta.md#function-setlore) (std::optional&lt; std::vector&lt; std::string &gt; &gt; lore) = 0<br>_Sets the lore for this item or removes lore when given_ `std::nullopt` _._ |
