...
|  [**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**DamageSource**](classendstone_1_1DamageSource.md) &gt; & | [**getDamageSource**](#function-getdamagesource) () const<br>_Get the source of damage._  |
...
```C++
inline const  NotNull < DamageSource > & endstone::ActorDamageEvent::getDamageSource () const
```
