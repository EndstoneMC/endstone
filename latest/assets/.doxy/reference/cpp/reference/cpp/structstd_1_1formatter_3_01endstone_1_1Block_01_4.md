...
[**ClassList**](annotated.md) **>** [**std**](namespacestd.md) **>** [**formatter&lt; endstone::Block &gt;**](structstd_1_1formatter_3_01endstone_1_1Block_01_4.md)
...
```C++
using std::formatter< endstone::Block >::Type =  endstone::Block;
```
...
inline auto std::formatter< endstone::Block >::format (
    const Type & val,
    FormatContext & ctx
) const
```
