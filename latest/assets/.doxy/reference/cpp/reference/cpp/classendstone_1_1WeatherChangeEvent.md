...
|  [**bool**](classendstone_1_1Identifier.md) | [**toWeatherState**](#function-toweatherstate) () const<br>_Gets the state of weather that the world is being set to._  |
...
_Gets the state of weather that the world is being set to._ 
```C++
