...
_Represents an entry for a banned IP address._ 
...
| Type | Name |
| ---: | :--- |
|  [**const**](classendstone_1_1Identifier.md) std::string | [**DateFormat**](classendstone_1_1BanEntry.md#variable-dateformat)   = `"%FT%[**T**](classendstone_1_1Identifier.md)%[**Ez"**](classendstone_1_1Identifier.md)`<br> |
