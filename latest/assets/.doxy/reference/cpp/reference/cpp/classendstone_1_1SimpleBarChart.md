...
# Class endstone::SimpleBarChart



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**SimpleBarChart**](classendstone_1_1SimpleBarChart.md)



_A bStats bar chart with a single bar per category._ 
...
| Type | Name |
| ---: | :--- |
| typedef std::function&lt; std::optional&lt; StringValues &gt;()&gt; | [**Callback**](#typedef-callback)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**SimpleBarChart**](#function-simplebarchart) (std::string chart\_id, Callback get\_values) <br> |
...
```C++
using endstone::SimpleBarChart::Callback =  std::function<std::optional<StringValues>()>;
```
...
```C++
inline endstone::SimpleBarChart::SimpleBarChart (
    std::string chart_id,
    Callback get_values
) 
```
...
```C++
inline virtual std::optional< JsonObject > endstone::SimpleBarChart::getChartData () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/metrics/simple_bar_chart.h`
