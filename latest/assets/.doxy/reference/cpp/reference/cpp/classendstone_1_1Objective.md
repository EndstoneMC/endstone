...
| virtual Result&lt; [**void**](classendstone_1_1Vector.md) &gt; | [**setDisplaySlot**](#function-setdisplayslot) (std::optional&lt; [**DisplaySlot**](namespaceendstone.md#enum-displayslot) &gt; slot) = 0<br>_Sets the display slot for this objective. This will remove it from any other display slot._  |
| virtual Result&lt; [**void**](classendstone_1_1Vector.md) &gt; | [**setSortOrder**](#function-setsortorder) ([**ObjectiveSortOrder**](namespaceendstone.md#enum-objectivesortorder) order) = 0<br>_Sets the sort order for this objective._  |
| virtual Result&lt; [**void**](classendstone_1_1Vector.md) &gt; | [**unregister**](#function-unregister) () const = 0<br>_Unregisters this objective from the associated_ [_**Scoreboard**_](classendstone_1_1Scoreboard.md) _._ |
