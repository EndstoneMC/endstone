...
# Class endstone::BlastingRecipe



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**BlastingRecipe**](classendstone_1_1BlastingRecipe.md)



_Represents a blasting recipe._ 
...
| Type | Name |
| ---: | :--- |
|   | [**~BlastingRecipe**](#function-blastingrecipe) () override<br> |
...
### function ~BlastingRecipe 

```C++
endstone::BlastingRecipe::~BlastingRecipe () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/inventory/blasting_recipe.h`
