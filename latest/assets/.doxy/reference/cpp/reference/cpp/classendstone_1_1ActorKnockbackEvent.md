...
_Gets the knockback that will be applied to the entity._ 
```C++
...
**Note:** this method returns a copy; changes must be applied via [**setKnockback()**](classendstone_1_1ActorKnockbackEvent.md#function-setknockback).
