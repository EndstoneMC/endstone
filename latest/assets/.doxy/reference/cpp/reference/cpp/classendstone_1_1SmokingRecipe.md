...
# Class endstone::SmokingRecipe



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**SmokingRecipe**](classendstone_1_1SmokingRecipe.md)



_Represents a smoking recipe._ 
...
| Type | Name |
| ---: | :--- |
|   | [**~SmokingRecipe**](#function-smokingrecipe) () override<br> |
...
### function ~SmokingRecipe 

```C++
endstone::SmokingRecipe::~SmokingRecipe () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/inventory/smoking_recipe.h`
