...
|  [**Level**](classendstone_1_1Level.md) & | [**getLevel**](#function-getlevel) () const<br>_Gets the level primarily involved with this event._  |
...
_Gets the level primarily involved with this event._ 
```C++
