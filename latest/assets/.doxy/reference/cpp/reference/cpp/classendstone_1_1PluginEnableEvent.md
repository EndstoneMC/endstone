...
|  [**Plugin**](classendstone_1_1Plugin.md) & | [**getPlugin**](#function-getplugin) () const<br>_Gets the plugin involved in this event._  |
...
_Gets the plugin involved in this event._ 
```C++
