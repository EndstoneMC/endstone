...
| virtual [**void**](classendstone_1_1Identifier.md) | [**unregister**](#function-unregister-12) (std::string name, [**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Service**](classendstone_1_1Service.md) &gt; & provider) = 0<br>_Unregister a particular provider for a particular service._  |
| virtual [**void**](classendstone_1_1Identifier.md) | [**unregister**](#function-unregister-22) ([**const**](classendstone_1_1Identifier.md) [**NotNull**](classendstone_1_1NotNull.md)&lt; [**Service**](classendstone_1_1Service.md) &gt; & provider) = 0<br>_Unregister a particular provider._  |
...
virtual void endstone::ServiceManager::unregister (
    std::string name,
    const  NotNull < Service > & provider
) = 0
```
