...
# Class endstone::FurnaceRecipe



[**ClassList**](annotated.md) **>** [**endstone**](namespaceendstone.md) **>** [**FurnaceRecipe**](classendstone_1_1FurnaceRecipe.md)



_Represents a furnace recipe._ 
...
| Type | Name |
| ---: | :--- |
|   | [**~FurnaceRecipe**](#function-furnacerecipe) () override<br> |
...
```C++
endstone::FurnaceRecipe::~FurnaceRecipe () override
```
...
------------------------------
The documentation for this class was generated from the following file `include/endstone/inventory/furnace_recipe.h`
