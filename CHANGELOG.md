...
- Fixed updating the server leaving out new `server.properties` entries that Bedrock ships commented out, such as `script-debugger-listen-address`, and adding back entries you had commented out yourself.
