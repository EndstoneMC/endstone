...
- `Mob.no_damage_ticks` for reading and changing the remaining damage-immunity ticks. Bedrock resets the window to 10 ticks on every hit, so there is no separate maximum to configure.
