...
- `EnchantItemEvent` for enchanting an item at an enchanting table. Cancelling it leaves the item, the player's experience levels and the lapis lazuli untouched.
