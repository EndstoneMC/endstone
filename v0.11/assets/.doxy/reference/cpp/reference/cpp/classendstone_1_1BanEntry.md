...
| Type | Name |
| ---: | :--- |
|  [**const**](classendstone_1_1Identifier.md) std::string | [**DateFormat**](#variable-dateformat)   = `"%FT%[**T**](classendstone_1_1Identifier.md)%[**Ez"**](classendstone_1_1Identifier.md)`<br> |
