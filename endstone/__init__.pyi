...
class Player(actor.Mob, OfflinePlayer):
    ...
    def play_sound(
        self, location: util.Location, sound: str, volume: typing.SupportsFloat = 1.0, pitch: typing.SupportsFloat = 1.0
    ) -> None:
        """
    ...
    @typing.overload
    def spawn_particle(self, name: str, location: util.Location, molang_variables_json: str | None = None) -> None:
        """
