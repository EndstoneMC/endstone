...
class Image:
    ...
    """
    @staticmethod
    def from_buffer(width: int, height: int, buffer: bytes) -> Image:
        """
...
class Skin:
    ...
    """
    def __init__(self, id: str, image: Image, cape_id: str | None = None, cape_image: Image | None = None) -> None:
        ...
    @property
