// Vendored from https://github.com/pybind/pybind11_json at d0bf434be9d287d73a963ff28745542daf02c08f.
// BSD 3-Clause; the licence text is in pybind11_json.LICENSE next to this file.
//
// Local change: the caster reports its type as typing.Any rather than json, because scripts/stubgen.py
// renders that name straight into the .pyi and a bare json is not a type Python knows.
/***************************************************************************
...
namespace pybind11
{
    namespace detail
    {
        ...
        {
        public:
            PYBIND11_TYPE_CASTER(nl::json, const_name("typing.Any"));
