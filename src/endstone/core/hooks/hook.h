...
#define ENDSTONE_HOOK_CALL_ORIGINAL(fp, ...) std::invoke(endstone::core::hook::get_original(fp), ##__VA_ARGS__)
#define ENDSTONE_HOOK_CALL_ORIGINAL_NAME(fp, name, ...) \
    std::invoke(endstone::core::hook::get_original(fp, name), ##__VA_ARGS__)
...
#define ENDSTONE_FACTORY_IMPLEMENT_OVERLOAD(type, fp, ...)                             \
    {                                                                                  \
        ...
        endstone::core::hook::get_ctor(fp, ctor_decorated_name)(obj, ##__VA_ARGS__); \
