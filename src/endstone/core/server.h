...
public:
    ...
    [[nodiscard]] std::unique_ptr<BlockData> createBlockData(Identifier<BlockType> type) const override;
    [[nodiscard]] std::unique_ptr<BlockData> createBlockData(Identifier<BlockType> type,
