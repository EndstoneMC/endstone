...
static bool fireShearEntityEvent(const ::Player &player, const ::Actor &target, const ::ItemStack &item,
                                                         ...
                                                         Vec3 const &location)
{
    ...
    if (!endstone::runtime::fireShearEntityEvent(player, *target, item, drops)) {
