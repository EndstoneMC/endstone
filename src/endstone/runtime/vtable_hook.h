...
void create(Obj *obj, Detour detour)
{
    void **vtable = *reinterpret_cast<void ***>(obj);
    details::create(vtable, Ordinal, detail::fp_cast(detour));
}
void *get_original(void *detour);
}  // namespace endstone::runtime::vhook

#define ENDSTONE_VHOOK_CALL_ORIGINAL(fp, ...)                                                                         \
    std::invoke(endstone::detail::fp_cast(fp, endstone::runtime::vhook::get_original(endstone::detail::fp_cast(fp))), \
                ##__VA_ARGS__)
