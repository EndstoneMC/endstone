...
void ActorSetPosSystem::moveHitboxTo(const Vec3 &pos, std::vector<Hitbox> &hitboxes)
{
...
AABB ActorSetPosSystem::refreshAABB(float offset, const Vec3 &position, const Vec2 &bb_dim)
{
...
void ActorSetPosSystem::setPosition(EntityContext &entity, const Vec3 &position, bool is_client_side)
{
    BEDROCK_CALL(&ActorSetPosSystem::setPosition, entity, position, is_client_side);
}
