...
struct AnimatePacketInfo {
    static constexpr auto PACKET_NAME = "AnimatePacket";
    static constexpr auto PACKET_ID = MinecraftPacketIds::Animate;
...
struct AnimatePacketPayload {
    ...
    Action action;
    float data;
    std::optional<ActorSwingSource> swing_source;
};
BEDROCK_STATIC_ASSERT_SIZE(AnimatePacketPayload, 24, 24);

class AnimatePacket : public SerializedPayloadPacket<AnimatePacketInfo, AnimatePacketPayload> {
public:
