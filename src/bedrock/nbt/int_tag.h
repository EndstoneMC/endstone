...
public:
    ...
    void write(IDataOutput &output) const override { output.writeInt(data); }
    ...
    [[nodiscard]] Type getId() const override { return Type::Int; }
    ...
    [[nodiscard]] std::unique_ptr<Tag> copy() const override { return std::make_unique<IntTag>(data); }
