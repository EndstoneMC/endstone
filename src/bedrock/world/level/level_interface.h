...
#include "bedrock/world/level/player_spawn_dimension_resolution.h"
...
public:
    ...
    virtual bool initialize(std::string const &, LevelSettings const &, Experiments const &, std::string const *,
                            OptionalResolvedBiomeDataReference) = 0;
    ...
    [[nodiscard]] virtual PlayerSpawnDimensionResolution resolvePlayerSpawnDimension(const CompoundTag *) const = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const DimensionManager> getDimensionManagerNonOwner() const = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<ActorAnimationGroup> getActorAnimationGroup() const = 0;
    ...
    [[nodiscard]] virtual const SharedTypes::Comprehensive::CameraPreset *getCameraPreset(int) const = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const GameplayUserManager> getGameplayUserManager() const = 0;
    ...
    [[nodiscard]] virtual int getNumRemotePlayers() const = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const TickDeltaTimeManager> getTickDeltaTimeManager() const = 0;
    ...
    [[nodiscard]] virtual StructureSpawnRegistry const &getStructureSpawnRegistry() const = 0;
    virtual StructureSpawnRegistry &getStructureSpawnRegistry() = 0;
    [[nodiscard]] virtual const Bedrock::NotNullNonOwnerPtr<StructureManager> getStructureManager() const = 0;
    ...
    [[nodiscard]] virtual const IWorldRegistriesProvider &getWorldRegistriesProvider() const = 0;
    ...
    virtual bool extinguishFire(BlockSource &, BlockPos const &, FacingID, Actor *) = 0;
    ...
    [[nodiscard]] virtual Bedrock::NonOwnerPointer<const ServerPlayerSleepManager> getServerPlayerSleepManager()
        const = 0;
    ...
    [[nodiscard]] virtual PhotoStorage &getPhotoStorage() const = 0;
    virtual void createPhotoStorage() = 0;
    virtual Bedrock::NotNullNonOwnerPtr<PhotoManager> getPhotoManager() = 0;
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const PhotoManager> getPhotoManager() const = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const EducationSettingsManager> getEducationSettingsManager()
        const = 0;
    virtual void save() = 0;
    ...
    virtual void playSound(LevelSoundEvent, Vec3 const &, int, ActorSoundIdentifier const &, bool) = 0;
    virtual void playSound(LevelSoundEvent, Vec3 const &, float, float) = 0;
    virtual void playSound(PlaySoundOptions const &) = 0;
    virtual void playSound(IConstBlockSource const &, LevelSoundEvent, Vec3 const &, int, ActorSoundIdentifier const &,
                           bool) = 0;
    virtual void playSound(DimensionType, LevelSoundEvent, Vec3 const &, int, ActorSoundIdentifier const &, bool) = 0;
    ...
    [[nodiscard]] virtual Bedrock::NonOwnerPointer<const ActorEventBroadcaster> getActorEventBroadcaster() const = 0;
    ...
    virtual void onSubChunkLoaded(ChunkSource &, LevelChunk &, SubChunkHeight, bool) = 0;
    ...
    virtual void addBreakingItemParticleEffect(Vec3 const &, BreakingItemParticleData const &,
                                               ResolvedItemIconInfo const &) = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const ChunkTickOffsetManager> getChunkTickOffsetManager()
        const = 0;
    ...
    virtual TradeTables *getTradeTables() = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const PlayerMovementSettingsManager>
    ...
    [[nodiscard]] virtual Bedrock::NonOwnerPointer<const TrustedSkinHelper> getTrustedSkinHelper() const = 0;
    ...
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<const PlayerListManager> getPlayerListManager() const = 0;
    ...
    [[nodiscard]] virtual IRandom &getIRandom() const = 0;
    ...
    virtual void takePicture(cg::ImageBuffer &, Actor *, Actor *, ScreenshotOptions &,
                             std::function<void(cg::ImageBuffer &, ScreenshotOptions &)>) = 0;
    virtual LevelSoundManager &getLevelSoundManager() = 0;
    [[nodiscard]] virtual Bedrock::NotNullNonOwnerPtr<SoundPlayerInterface> getSoundPlayer() const = 0;
    ...
    virtual Bedrock::NotNullNonOwnerPtr<PlayerPermissionsManagerImpl> getPlayerPermissionsManager() = 0;
    ...
    [[nodiscard]] virtual Bedrock::NonOwnerPointer<const ChunkGenerationManager> getChunkGenerationManager() const = 0;
    ...
    virtual ClientLevel *asClientLevel() = 0;
    [[nodiscard]] virtual Bedrock::NonOwnerPointer<const CameraRegistry> getCameraRegistry() const = 0;
